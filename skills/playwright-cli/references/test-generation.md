...
Plan / generate / heal lean on the same mechanic: run `npx playwright test --debug=cli` in the background, then `playwright-cli attach tw-XXXX` to drive the paused page interactively. See [.agents/skills/playwright-cli/references/playwright-tests.md](.agents/skills/playwright-cli/references/playwright-tests.md) for the debug/attach mechanics.
...
| For... | See |
|---|---|
| `--debug=cli` / attach mechanics | [.agents/skills/playwright-cli/references/playwright-tests.md](.agents/skills/playwright-cli/references/playwright-tests.md) |
| Mocking requests during exploration/generation | [.agents/skills/playwright-cli/references/request-mocking.md](.agents/skills/playwright-cli/references/request-mocking.md) |
| Managing the CLI browser session | [.agents/skills/playwright-cli/references/session-management.md](.agents/skills/playwright-cli/references/session-management.md) |
